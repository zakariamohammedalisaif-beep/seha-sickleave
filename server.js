    ...
    <div style="display:flex; justify-content:space-between; align-items:flex-start; padding: 0; margin-top:8px; margin-right:-10px;">
      ...
      <div style="display:flex; flex-direction:column; align-items:center;">
        ...
        const savedReport = await dataManager.saveReport({
            ...
            status: 'issued',
            data: {
                raw_form: d.raw_form || null,
                raw_admission_date: d.raw_admission_date || '',
                raw_discharge_date: d.raw_discharge_date || '',
                raw_issue_date: d.raw_issue_date || '',
                raw_issue_time: d.raw_issue_time || '',
                leave_type: d.leave_type || (sanitizedLeaveId.startsWith('PSL') ? 'PSL' : 'GSL'),
                nationality: d.nationality || d.nationalityAr || 'السعودية',
                nationality_ar: d.nationalityAr || d.nationality || 'السعودية',
                nationality_en: d.nationalityEn || 'Saudi Arabia',
                employer: d.employerAr || d.employer || '',
                employer_ar: d.employerAr || d.employer || '',
